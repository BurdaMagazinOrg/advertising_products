 ...
 *
 * @QueueWorker(
 *   id = "advertising_product_update",
 *   title = @Translation("Advertising product update"),
 *   cron = {"time" = 60}
 * )
 */
class AdvertisingProductUpdate extends QueueWorkerBase implements ContainerFactoryPluginInterface {
